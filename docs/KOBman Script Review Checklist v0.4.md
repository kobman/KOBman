...
|D.4|All KOBman  environment scripts should have standard set of functions included in them and follow the following naming convention <br> <br>__kob_XXXX() function  where XXXX is the corresponding command <br> <br> e.g. <br> __kob_install () <br> __kob_uninstall() <br> __kob_update() <br> __kob_upgrade() <br> __kob_validate() <br> __kob_start() <br> __kob_stop()
