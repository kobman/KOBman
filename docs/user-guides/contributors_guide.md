...
The following is a set of guidelines for contributing to KOBman and its related projects, which are hosted in the [hyperledgerkochi repository](https://github.com/hyperledgerkochi) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
