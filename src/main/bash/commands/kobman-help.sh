...
function __kob_help {
	...
	__kobman_echo_white ""
	__kobman_echo_white "Qualifiers   : Environments, Namespace, Version"
	__kobman_echo_white ""
	...
	__kobman_echo_white ""
	__kobman_echo_white "uninstall    : $ kob uninstall --environment {some-env-name}"
	...
	__kobman_echo_blue "               -------------------------"
	__kobman_echo_white "               $ kob --version --environment {some-env-name}"
	__kobman_echo_white "               The command displays the version of the specified "
	__kobman_echo_white "               environment."
	__kobman_echo_white "               Eg: $ kob --version --environment greenlight"
	__kobman_echo_white ""
